...
That settles **6 of 53**. It cannot settle the other
**47**, because Yahoo's search only matches *current legal* names — it
...
## 2. Undecidable without the transcript — 47 ticker(s)
