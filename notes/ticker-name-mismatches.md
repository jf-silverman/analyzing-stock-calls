...
That settles **6 of 54**. It cannot settle the other
...
| `BK` | **Bob Evans Farms** | Bank of New York Mellon Corp | **no** | **✗** / yes | 2026-06-23 · opening_commentary · [0:17](https://youtu.be/TW-oqAAfZDY?t=17) | …at Bob Evans Farms. I mean, I figured that'd be a more rigorous approach,… |
...
| `BURL` | **Burlington Coat Factory** | Burlington Stores, Inc. | ~ | **✗** / yes | 2026-04-07 · opening_commentary · [0:01](https://youtu.be/8at2Eyt89RQ?t=1) | …Ross and Burlington. These have been phenomenal performers leaving their… |
...
## 3. Name variants — 6 ticker(s), cosmetic only
...
_Checked 829 tickers with a stored company name. Tickers Yahoo does not
